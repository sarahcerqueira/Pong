...
(
    ...
    localparam PAD7 = log2ceil(64'h3070 - 64'h3068); 
    // -------------------------------------------------------
    ...
    // ( 0x2800 .. 0x3000 )
    if ( {address[RG:PAD0],{PAD0{1'b0}}} == 14'h2800   ) begin
            src_channel = 9'b00000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x3000 .. 0x3010 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 14'h3000  && read_transaction  ) begin
    ...
    // ( 0x3068 .. 0x3070 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 14'h3068   ) begin
